...
const uint16_t sine_lut_size_0 = 136; // sine wave size bit '0' 32000 Hz
static uint16_t array_bit0[sine_lut_size_0] = {
0x000, 0x09C, 0x258, 0x4F0, 0x800, 0xB0F, 0xDA7, 0xF63, 
0xFFF, 0xF63, 0xDA7, 0xB0F, 0x800, 0x4F0, 0x258, 0x09C, 
0x000, 0x000, 0x09C, 0x258, 0x4F0, 0x800, 0xB0F, 0xDA7, 0xF63, 
0xFFF, 0xF63, 0xDA7, 0xB0F, 0x800, 0x4F0, 0x258, 0x09C, 
0x000, 0x000, 0x09C, 0x258, 0x4F0, 0x800, 0xB0F, 0xDA7, 0xF63, 
0xFFF, 0xF63, 0xDA7, 0xB0F, 0x800, 0x4F0, 0x258, 0x09C, 
0x000, 0x000, 0x09C, 0x258, 0x4F0, 0x800, 0xB0F, 0xDA7, 0xF63, 
...
const uint16_t sine_lut_size_1 = 120; // sine wave size bit '1' 34000 Hz
...
void buildMessageLUT (uint8_t* data, uint8_t num_bytes) {
    int sync_signal_size = sine_lut_size_1;
