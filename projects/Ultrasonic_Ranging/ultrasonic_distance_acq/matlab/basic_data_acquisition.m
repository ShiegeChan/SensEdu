%% Note: this code will not work with the latest ultrasonic_distance_acq.ino,
%% which transmits 3 peaks per mic. Use the multi-peak-tracking script instead.
...
DATA_LENGTH = 32 * 32; % Match in Arduino!
